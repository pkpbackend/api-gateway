...
class PengumumanService {
  ...
  static async findAll(params, accessTokenInternal) {
    ...
    const response = await apiPortalWithAuth.get('/pengumuman/all', {
      params,
    })
  ...
  static async findAllPaginate(params, accessTokenInternal) {
    const apiPortalWithAuth = mkApiPortalPerumahan(accessTokenInternal)
    const response = await apiPortalWithAuth.get('/pengumuman', {
      params,
    })
    return response.data
  }
  ...
  static async findById(id, accessTokenInternal) {
    const apiPortalWithAuth = mkApiPortalPerumahan(accessTokenInternal)
    const response = await apiPortalWithAuth.get(`/pengumuman/${id}`)
    return response.data
  }
  ...
  static async create(body, attachments, accessTokenInternal) {
    ...
    try {
      response = await apiPortalWithAuth.post('/pengumuman', body)
    } catch (error) {
    ...
    if (
      ...
      await apiPortalWithAuth.put(`/pengumuman/${id}/attachments`, form, {
  ...
  static async update(id, body, attachments, accessTokenInternal) {
    ...
    try {
      response = await apiPortalWithAuth.put(`/pengumuman/${id}`, body)
    } catch (error) {
      response = error.response
      throw new ResponseError.BadRequest(response?.data?.message)
    }
  ...
  static async deleteById(id, accessTokenInternal) {
    const apiPortalWithAuth = mkApiPortalPerumahan(accessTokenInternal)
    const response = await apiPortalWithAuth.delete(`/pengumuman/${id}`)
    return response.data
  }
}
